...
$(function() {
    var html = '<div id="kmsjsmap_contextmenu"><ul class="kmsjsmap-dropdown-menu"><li><a href="javascript: kmsjsmap.add_node();">添加节点</a></li><li><a href="javascript: kmsjsmap.modify_node()">编辑节点</a></li><li><a href="javascript: kmsjsmap.del_node()">删除节点</a></li><li><a href="javascript: kmsjsmap.relation_node()">删除节点</a></li><li><a href="javascript: kmsjsmap.addvedio()">上传对应视频</a></li></ul></div>';
...
(function($w) {
    ...
    jm.view_provider.prototype = {
        ...
        set_theme: function(theme) {
            console.log(this);
                this.e_nodes.className = 'theme-' + theme;
        },
...
(function($w) {
    ...
    kmsjsmap._load_jsmind = function() {
        ...
        var innerToolBar = $("<div class='lui-jsmind-innerToolBar'><ul><li class='lui_map_icon_zoom_reset mui mui-history_handler_back' title='还原' data-opt='zoomReset' ></li>" +
            ...
            '<li class=\'lui_map_icon_zoom_out mui mui-delete\' title=\'截图\' data-opt=\'\' onclick=\'kmsjsmap.screenshot()\'></li>'+
            " </ul></div>");
    ...
    kmsjsmap.change = function(dataing) {
        // _jm.get_data('node_array').data=dataing;
        _jm.set_theme(dataing);
    ...
    //为节点添加视频
    kmsjsmap.addvedio=function(){
        $conTextMenu.hide();
        var node = _jm.get_selected_node();
        console.log(node);
        information.NowTreenodeId=node.id;
        $('#touploadVedio').modal('show');
    }
    //得到节点信息
    kmsjsmap.getnodeinformation=function(){
    ...
    kmsjsmap.resettheme =function(theme){
        _jm.set_theme(theme)
    }
